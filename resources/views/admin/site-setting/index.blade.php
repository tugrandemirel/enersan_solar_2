    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Site Ayarları</h5>
                <!--end::Title-->
                <!--begin::Separator-->
                    ...
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0 mr-7">
                            <div class="symbol symbol-50 symbol-lg-120 symbol-light-danger">
                                <img src="{{ asset($general_setting?->getLogoImage() ?? '') }}" alt="">
                            </div>
                        </div>
                        <!--end::Pic-->
                        <!--begin: Info-->
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="mr-3">
                                    <div class="d-flex align-items-center mr-3">
                                        <!--begin::Name-->
                                        <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">{{ $general_setting->site_name }}</a>
                                        <!--end::Name-->
                                    </div>
                                    <!--begin::Contacts-->
                                    <div class="d-flex flex-wrap my-2">
                                        ...
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">
                                            <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                                ...
                                                <!--end::Svg Icon-->
                                            </span>{{ $contact_setting?->address ?? '' }}</a>
                                    </div>
                                    <span class="font-weight-bold text-dark-50">{{ $general_setting?->slogan ?? '' }}</span>
                                    <!--end::Contacts-->
                                </div>
                                <!--begin::User-->
                            </div>
                ...
                <div class="card-body">
                    <div class="tab-content pt-5">
                        ...
                        <div class="tab-pane active" id="kt_apps_contacts_view_tab_2" role="tabpanel">
                            @include('admin.site-setting.partials.general-setting')
                        </div>
                        <!--end::Tab Content-->
                        <!--begin::Tab Content-->
                        <div class="tab-pane" id="kt_apps_contacts_view_tab_4" role="tabpanel">
                            @include('admin.site-setting.partials.contact-setting')
                        </div>
                        <div class="tab-pane" id="kt_apps_contacts_view_tab_5" role="tabpanel">
                            @include('admin.site-setting.partials.social-media-setting')
                        </div>
                        <!--end::Tab Content-->
                    </div>
                </div>
