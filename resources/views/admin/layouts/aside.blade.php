    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-{{ $sliderToggle ?? '' }}" aria-haspopup="true">
                    <a href="{{ route('admin.sliders.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Sliderlar</span>
                    </a>
                </li>

                <li class="menu-item menu-item-{{ $projectToggle ?? '' }}" aria-haspopup="true">
                    <a href="{{ route('admin.projects.index') }}" class="menu-link">
                        ...
                        <span class="menu-text">Projelerimiz</span>
                    </a>
                </li>

                <li class="menu-item menu-item-{{ $servicesToggle ?? '' }}" aria-haspopup="true">
                ...
                <li class="menu-item menu-item-{{ $siteSettingToggle ?? '' }}" aria-haspopup="true">
                    <a href="{{ route('admin.site_setting.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="features/widgets/lists.html" class="menu-link">
                                    ...
                                    <span class="menu-text">Resim Galeri</span>
                                </a>
                            </li>
                        </ul>
                    </div>
