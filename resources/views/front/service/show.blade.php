...
@section("title", "Enersan Solar | ". $service?->name)
...
@section("content")
    ...
    <section class="page-title page-title-layout2 bg-overlay bg-overlay-2 bg-parallax">
        <div class="bg-img"><img src="{{ asset($service?->image?->path) }}" alt="{{ $service?->name }}"></div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-6">
                    <h1 class="pagetitle__heading mb-0">{{ $service?->name }}</h1>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route("services.index") }}">Hizmetlerimiz</a></li>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <aside class="sidebar has-marign-right mb-30">
                        ...
                        <div class="widget widget-categories">
                            <h5 class="widget__title">Diğer Hizmetlerimiz</h5>
                            <div class="widget-content">
                                <ul class="list-unstyled">
                                    @foreach($other_services as $other_service)
                                    <li>
                                        <a href="{{ route("services.show", ["service_slug" => $other_service?->slug]) }}" class="active">
                    ...
                    <div class="row features-layout3">
                        ...
                        <div class="col-sm-4">
                            <div class="feature-item">
                                ...
                                <a href="{{ route("services.index") }}" class="btn__link">
