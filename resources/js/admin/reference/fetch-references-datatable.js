...
"use strict"
let ReferencesDatatablesDataSourceAjaxServer = function () {

    let initTable1 = function () {
        let fetch_references_datatable = $('#fetch_references_datatable');
        ...
        // begin first table
        fetch_references_datatable.DataTable({
            "fixedHeader": {
                "header":true
            },
            responsive: true,
          ...
          <'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        let delete_url = route.admin.references.destroy.replace("{reference_uuid}", row?.uuid);
                        return `
                            <a href="#" class="btn btn-icon btn-light btn-sm delete_reference_btn" data-value="${row?.uuid}">
...
$(document).ready(function () {
    ReferencesDatatablesDataSourceAjaxServer.init();
});
